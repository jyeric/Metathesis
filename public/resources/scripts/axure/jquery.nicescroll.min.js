    ...
    x = function(e, p) {
        ...
        if ((T.isie11 || T.isie10) && (e["-ms-overflow-style"] = "none"), m.ishwscroll && (this.doc.css(T.transitionstyle, T.prefixstyle + "transform 0ms ease-out"), T.transitionend && m.bind(m.doc, T.transitionend, m.onScrollTransitionEnd, !1)), m.zindex = "auto", m.ispage || "auto" != g.zindex ? m.zindex = g.zindex : m.zindex = function() {
          ...
          if (!1 === g.autohidemode ? (m.autohidedom = !1, m.rail.css({
            ...
            m.ontouchstart = function(e) {
              ...
              if (m.hasmoving = !1, m.scrollmom.timer && (m.triggerScrollEnd(), m.scrollmom.stop()), !m.railslocked) {
                ...
                if (g.horizrailenabled ? m.rail.drag = {
                    x: e.clientX,
                    y: e.clientY,
                    sx: m.scroll.x,
                    sy: m.scroll.y,
                  ...
                  var i = c.width(),
                    ...
                    a = l.h - s,
                    d = l.w - i;
                  m.rail.scrollable && !m.railh.scrollable ? m.rail.drag.ck = a > 0 && "v" : !m.rail.scrollable && m.railh.scrollable ? m.rail.drag.ck = d > 0 && "h" : m.rail.drag.ck = !1
                }
                if (g.emulatetouch && m.isiframe && T.isie) {
                  var u = m.win.position();
                  m.rail.drag.x += u.left, m.rail.drag.y += u.top
                }
                if (m.hasmoving = !1, m.lastmouseup = !1, g.horizrailenabled ? m.scrollmom.reset(e.clientX, e.clientY) : m.scrollmom.reset(0, e.clientY), o && t) {
            ...
            m.ontouchmove = function(e, o) {
              ...
              if (2 == m.rail.drag.pt) {
                ...
                if (m.railh && m.railh.scrollable && (u = m.isrtlmode ? c - m.rail.drag.sl : m.rail.drag.sl - c, m.ishwscroll && g.bouncescroll ? u < 0 ? u = Math.round(u / 2) : u > m.page.maxw && (u = m.page.maxw + Math.round((u - m.page.maxw) / 2)) : (u < 0 && (u = 0, a = 0), u > m.page.maxw && (u = m.page.maxw, a = 0))), !m.hasmoving) {
                  ...
                  g.horizrailenabled ? m.triggerScrollStart(e.clientX, e.clientY, 0, 0, 0) : m.triggerScrollStart(0, e.clientY, 0, 0, 0), m.hasmoving = !0
                }
              ...
              if (!m.rail.drag || 3 == m.rail.drag.pt) {
                ...
                m.cancelScroll(), g.horizrailenabled ? m.rail.drag = {
          ...
          if (m.onmousedown = function(e, o) {
              ...
              if (m.rail.drag) {
                ...
                if (m.cursorfreezed = !0, g.horizrailenabled ? m.hasmoving || m.triggerScrollStart(e.clientX, e.clientY, 0, 0, 0) : m.hasmoving || m.triggerScrollStart(0, e.clientY, 0, 0, 0), m.hasmoving = !0, m.rail.drag.hr) {
                  if (g.horizrailenabled) {
      ...
      function X(e, o, t, r) {
        ...
        if (H = w(), i > 350 ? B = 1 : B += (2 - B) / 10, o = o * B | 0, e = e * B | 0) {
          ...
          var s = e > 0 ? 1 : -1;
          O !== s && (m.scrollmom && m.scrollmom.stop(), m.newscrollx = m.getScrollLeft(), O = s), m.lastdeltax -= e
        }
        if (o) {
          if (function() {
          ...
          var l = o > 0 ? 1 : -1;
          I !== l && (m.scrollmom && m.scrollmom.stop(), m.newscrolly = m.getScrollTop(), I = l), m.lastdeltay -= o
